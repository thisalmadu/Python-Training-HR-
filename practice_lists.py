...
def pig_latin(text):
  ...
  for word in words:
    ...
    word = "{}{}".format(word,word[0])
    word = word[1:]
    say = "{}{}{}{}".format(say,word,"ay"," ")
...
#a string with the format: group_name: member1, member2, …
#For example, group_list("g", ["a","b","c"]) returns "g: a, b, c".

def group_list(group, users):
  members = [m for m in users]
...
#should print out: Ken is 30 years old and works as
#Chef. Pat is 35 years old and works as Lawyer. Amanda is 25 years old and works as Engineer.
